    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if (Auth::user()->role == 'admin')
                ...
                <x-responsive-nav-link :href="route('admin.alat')" :active="request()->routeIs('admin.alat')">
                    {{ __('Alat') }}
                </x-responsive-nav-link>
                <x-responsive-nav-link :href="route('admin.user')" :active="request()->routeIs('admin.user')">
                    {{ __('User') }}
                </x-responsive-nav-link>
                <x-responsive-nav-link :href="route('admin.peminjaman')" :active="request()->routeIs('admin.peminjaman')">
                    {{ __('Peminjaman') }}
                </x-responsive-nav-link>
            @endif
        </div>
